...
var holydaycalendar = {
    data: {
        ...
        2026: {
            ...
            pentecost: {start: "2026-05-24"},
            trumpets: {start: "2026-09-12"},
            atonement: {start: "2026-09-21"},
            tabernacles: {
                start: "2026-09-26",
                end: "2026-10-02"
            },
            eighthday: {start: "2026-10-03"}
        },
        2027: {
            passover: {start: "2027-04-21"},
            daysOfUnleavenedBread: {
                start:"2027-04-22",
                end:"2027-04-28"
            },
            pentecost: {start: "2027-06-13"},
    ...
    strings: {
        festivaldays: {
            ...
            daysOfUnleavenedBread: {
                ...
                "es": "Fiesta de los Panes sin Levadura",
                "fr": "Fête des Pains sans Levain",
                "pt": "Festa dos Pães Asmos",
                "de": "Fest der Ungesäuerten Brote",
                "it": "Festa degli Azzimi",
                "nl": "Feest van het Ongedesemde Brood"
            },
            pentecost: {
                "en": "Pentecost",
                "es": "Pentecostés",
            ...
            trumpets: {
                "en": "Feast of Trumpets",
                "es": "Fiesta de las Trompetas",
                "fr": "Fête des Trompettes",
                "pt": "Festa das Trombetas",
                "de": "Fest der Posaunen",
                "it": "Festa delle Trombe",
                "nl": "Feest van de Bazuinen"
            },
            atonement: {
                "en": "Day of Atonement",
            ...
            tabernacles: {
                ...
                "fr": "Fête des Tabernacles",
                "pt": "Festa dos Tabernáculos",
                "de": "Laubhüttenfest",
                "it": "Festa delle Capanne",
                "nl": "Loofhuttenfeest"
            },
            eighthday:{
                "en": "The Eighth Day",
        ...
        interface: {
            "eveningbefore":{
                "en": "Begins the evening before",
                "es": "Comienza la noche anterior",
                "fr": "Commence la veille au soir",
                "pt": "Começa na noite anterior",
                "de": "Beginnt am Vorabend",
                "it": "Inizia la sera prima",
                "nl": "Begint de avond ervoor"
            },
            "observedeveningbefore": {
                "en": "Observed the evening before",
                "es": "Observado la noche anterior",
                "fr": "Observé la veille au soir",
                "pt": "Observado na noite anterior",
                "de": "Am Vorabend beobachtet",
                "it": "Osservato la sera prima",
                "nl": "Geobserveerd de avond ervoor"
            },
            "observance": {
                "en": "Observance",
                "es": "Observancia",
...
var topics =[
    {id: "christianliving", name: "Christian Living", hymns: [
        105,179,157,99,170,176,182,172,132,187,106,89,2,100,150,168,107,119,23,10
    ]},
    {id: "churchcommission", name: "CHURCH OF GOD, CHURCH'S COMMISSION, PEOPLE OF GOD", hymns: [
        108,105,179,157,177,170,38,164,178,176,152,101,148,172,98,171,175,169,107,181,133
    ]},
    {id: "comfortencouragement", name: "COMFORT, ENCOURAGEMENT", hymns: [
        144,142,167,147,16,14,13,15,5
    ]},
    {id: "committment", name: "COMMITMENT", hymns: [
        105,116,177,170,24,120
    ]},
    {id: "confidencecourage", name: "CONFIDENCE, COURAGE", hymns: [
        105,116,177,170,24,120
    ]},
    {id: "creatorcreation", name: "CREATOR, CREATION", hymns: [
        110,154,178,95,135,7,136,159,138,11,186
    ]},
    {id: "family", name: "Family", hymns: [
        77,178,148,98,89,124,153,181,76
    ]},
    {id: "fellowship", name: "FELLOWSHIP", hymns: [
        157,180,172,132,187,106
    ]},
    {id: "godthefather", name: "GOD THE FATHER", hymns: [
        189,149,155,61,130,186
    ]},
    {id: "godsblessings", name: "GOD'S BLESSINGS", hymns: [
        21,77,1,28,113,167,114,55,18,20,41
    ]},
    {id: "godsfaithfulness", name: "GOD'S FAITHFULNESS", hymns: [
        143,155,102,167,147,16,48,40,171,18,137,158,14,13,15,90,23,76
    ]},
    {id: "godsgreatnessandpower", name: "GOD'S GREATNESS AND POWER", hymns: [
        143,28,154,134,125,135,122,147,39,57,129,145,51,159,90
    ]},
    {id: "godsguidanceandcare", name: "GOD'S GUIDANCE AND CARE", hymns: [
        180,27,125,48,83,40,14,13,15,75
    ]},
    {id: "godsplan", name: "GOD'S PLAN", hymns: [
        165,163,97,189,177,148,149,155,182,135,60,146,190,185,103,166,94,96,109,156,141,130,191,47
    ]},
    {id: "heritage", name: "HERITAGE", hymns: [
        151,116,38,34,182,26,158,141
    ]},
    {id: "holydayssabbath", name: "HOLY DAYS, SABBATH", hymns: [
        140,105,163,179,97,189,188,115,176,161,149,155,122,31,190,111,184,114,61,112,42,166,50,32,118,43,94,96,109,156,141,104,160,123,191,67,47
    ]},
    {id: "hope", name: "HOPE", hymns: [
        142,35,167,24,120
    ]},
    {id: "jesuschristlambofgod", name: "JESUS CHRIST - LAMB OF GOD", hymns: [
        161,149,155,146,184,130
    ]},
    {id: "jesuschristlordsaviorandking", name: "JESUS CHRIST - LORD, SAVIOR AND KING", hymns: [
        151,140,92,188,182,131,137,173,169,156
    ]},
    {id: "jesuschristsecondcoming", name: "JESUS CHRIST - SECOND COMING", hymns: [
        140,97,94,96,156,141,104,160,191
    ]},
    {id: "kingdomofgod", name: "KINGDOM OF GOD", hymns: [
        97,189,161,94,96,109,156,141
    ]},
    {id: "lawofgod", name: "LAW OF GOD", hymns: [
        73,74,89,12,72,2,11
    ]},
    {id: "love", name: "LOVE", hymns: [
        155,106,171,90
    ]},
    {id: "mercypeace", name: "MERCY, PEACE", hymns: [
        142,180,149,155,79,31,114,83,61,118,20,17,5,120
    ]},
    {id: "obedience", name: "OBEDIENCE", hymns: [
        93,116,139,179,77,73,71,82
    ]},
    {id: "patience", name: "PATIENCE", hymns: [
        165,142,80,24
    ]},
    {id: "praise", name: "PRAISE", hymns: [
        151,140,63,59,9,38,178,95,30,134,84,6,45,22,8,51,36,136,81,126,174,29,52,53,64,26,65,55,85,66,131,68,78,137,42,159,69,86,87,138,25,56,43,54,130,123,162,127
    ]},
    {id: "prayer", name: "Prayer", hymns: [
        139,33,34,4,125,46,31,114,183,37,44,32,118,5
    ]},
    {id: "promises", name: "Promises", hymns: [
        165,97,63,102,60,103
    ]},
    {id: "protection", name: "Protection", hymns: [
        143,180,27,48,40,14,13,15
    ]},
    {id: "repentancereconciliation", name: "REPENTANCE, RECONCILIATION", hymns: [
        105,179,176,149,155,61,118
    ]},
    {id: "thankfullnessjoy", name: "THANKFULNESS, JOY", hymns: [
        113,30,79,49,36,136,117,64,70,124,58,168,160,62
    ]},
    {id: "trialstrust", name: "TRIALS, TRUST", hymns: [
        144,165,93,142,143,80,99,9,164,35,102,167,147,60,46,114,19,16,70,37,25,119,17,3,5,24
    ]},
    {id: "unity", name: "UNITY", hymns: [
        172,132,187,171,175,168,181,133
    ]},
    {id: "worship", name: "WORSHIP", hymns: [
        151,140,121,139,63,59,115,95,122,84,39,57,7,6,45,74,22,88,36,184,81,117,52,53,65,131,68,91,3,127,186
    ]},
    {id: "youth", name: "YOUTH", hymns: [
        115,38,148,98,73,71,22,124,153,160
    ]},
    {id: "zeal", name: "ZEAL", hymns: [
        151,140,182,84,88,36,185,55,175,173,56,58
    ]},
