var DragDropTouch = (function (exports) {
  'use strict';
  ...
  if ((_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('drag-drop-touch.min.js', document.baseURI).href).includes(`?autoload`)) {
  ...
  exports.enableDragDropTouch = enableDragDropTouch;
